...
import net.mcreator.chernobylv.procedures.EnergyPoweredSmelterGUIProcProcedure;
...
public class EnergyPoweredSmelterBlock extends ChernobylvModElements.ModElement {
	@ObjectHolder("chernobylv:energy_powered_smelter")
	public static final Block block = null;
	@ObjectHolder("chernobylv:energy_powered_smelter")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EnergyPoweredSmelterBlock(ChernobylvModElements instance) {
		super(instance, 26);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("energy_powered_smelter"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("energy_powered_smelter");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				EnergyPoweredSmelterGUIProcProcedure.executeProcedure($_dependencies);
			}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("energy_powered_smelter");
		}
