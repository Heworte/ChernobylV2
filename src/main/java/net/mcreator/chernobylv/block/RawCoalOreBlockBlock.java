...
public class RawCoalOreBlockBlock extends ChernobylvModElements.ModElement {
	@ObjectHolder("chernobylv:raw_coal_ore_block")
	public static final Block block = null;
	public RawCoalOreBlockBlock(ChernobylvModElements instance) {
		super(instance, 8);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("raw_coal_ore_block");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("chernobylv:raw_coal_ore_block_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 30)).range(50)
