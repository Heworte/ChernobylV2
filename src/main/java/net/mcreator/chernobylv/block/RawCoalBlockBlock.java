...
public class RawCoalBlockBlock extends ChernobylvModElements.ModElement {
	@ObjectHolder("chernobylv:raw_coal_block")
	public static final Block block = null;
	public RawCoalBlockBlock(ChernobylvModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("raw_coal_block");
		}
