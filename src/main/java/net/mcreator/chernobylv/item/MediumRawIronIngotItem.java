...
public class MediumRawIronIngotItem extends ChernobylvModElements.ModElement {
	@ObjectHolder("chernobylv:medium_raw_iron_ingot")
	public static final Item block = null;
	public MediumRawIronIngotItem(ChernobylvModElements instance) {
		super(instance, 18);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("medium_raw_iron_ingot");
		}
