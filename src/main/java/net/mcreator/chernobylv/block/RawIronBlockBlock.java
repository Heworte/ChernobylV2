...
public class RawIronBlockBlock extends ChernobylvModElements.ModElement {
	@ObjectHolder("chernobylv:raw_iron_block")
	public static final Block block = null;
	public RawIronBlockBlock(ChernobylvModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("raw_iron_block");
		}
